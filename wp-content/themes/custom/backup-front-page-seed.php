...
<body id="page-top">
  ...
  <div class="wrapper" style="display: none;">
    ...
    <!-- Section Additional -->
    <section id="section-additional" class="text-center">
      <div class="container">
        <div class="row">
    ...
    <!-- Section Video -->
    <!-- <section id="section-video-big" class="pb-0">
      <div class="">
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe style="width: 100%" src="https://www.youtube.com/embed/802CoDfAEZA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="<?php echo get_template_directory_uri(); ?>/assets-child/img/coffe-1.jpg" alt="">
